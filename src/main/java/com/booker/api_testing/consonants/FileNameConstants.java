package com.booker.api_testing.consonants;

public class FileNameConstants {
	
	public static final String BASE_PATH ="./src/test/java/resources/";
	...
	public static final String EXCEL_TEST_DATA = BASE_PATH+"Apitestdata.xlsx";
	
	public static final String TEST_RUNNER = BASE_PATH+"TestRunner.xlsx";
	
	public static final String Get_JSON_SCHEMA = BASE_PATH+"get_response.json";
